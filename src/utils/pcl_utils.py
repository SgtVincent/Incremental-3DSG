...
# Based on https://github.com/mithi/point-cloud-clusters 
...
def ros_to_pcl(ros_cloud):
    """ Converts a ROS PointCloud2 messapcl_helper
        Returns:
...
def ros_to_pcl_intensity(ros_cloud):
    ...
    points_list = list(pc2.read_points(ros_cloud, skip_nans=True, field_names = field_names))
...
def pcl_xyzi_to_ros(pcl_array):
    """ Converts a pcl PointXYZI to a ROS PointCloud2 message
    ...
    ros_msg = pc2.create_cloud(header, fields, points)
