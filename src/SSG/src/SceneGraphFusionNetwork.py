...
from SSG.src.DataLoader import CustomDataLoader
from SSG.src.model_SGFN import SGFNModel
from SSG.src.model_SGPN import SGPNModel
from SSG.src.dataset_builder import build_dataset
from torch.utils.tensorboard import SummaryWriter
from SSG.src.config import Config
import SSG.src.op_utils as op_utils
from SSG.utils import plot_confusion_matrix
from SSG.utils import util_eva
...
class SGFN():
    def __init__(self, config):
        ...
        # DEBUG
            ...
            self.dataset_eval = build_dataset(self.config,split_type='validation_scans', shuffle_objs=False,
                                      multi_rel_outputs=mconfig.multi_rel_outputs,
                                      use_rgb=mconfig.USE_RGB,
                                      use_normal=mconfig.USE_NORMAL)
            num_obj_class = len(self.dataset_eval.classNames)
    ...
    def trace(self):
        ...
        with open(os.path.join(self.trace_path, 'classes160.txt'), 'w') as f:
...
if __name__ == '__main__':
    ...
    config.dataset.root = "../data/all_es"
