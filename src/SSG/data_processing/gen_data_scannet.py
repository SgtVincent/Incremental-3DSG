...
def Parser(add_help=True):
    ...
    parser.add_argument('--type', type=str, default='train', choices=['train', 'validation'], help="allow multiple rel pred outputs per pair",required=False)
    parser.add_argument('--label_type', type=str,default='ScanNet20', 
                        choices=['NYU40','ScanNet20'], help='label',required=False)
    ...
    parser.add_argument('--scan_name', type=str,choices=['inseg.ply','cvvseg.ply'], default='inseg.ply', help='')
...
if __name__ == '__main__':
    ...
    for scan_id in tqdm(sorted(scan_ids)):
        ...
        relationships, segs_neighbors = process(define.SCANNET_DATA_PATH,scan_id,label_type = args.label_type)
